...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /*수업목표. 값을 직접 연산하여 출력할수 있다.*/
        // *값의 형태에 따라서 사용할수 있는 연산자의 종류와
        // 연산의 결과가 달라지게 된다.
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10);
        // 수학적으로 사용하는 사칙연산에 추가적으록
        // 나머지를 구하는 연산(mod)을 사용할수 있다.
        // /-> 몫 , % -> 나머지
        ...
        /*
        * 컴퓨터는 문자를 인식하지 못하고 숫자로만 인삭을 할 수 있기 때문에
...
//        System.out.println("hello" / "world");
//        System.out.println("hello" % "world");
        // 한번에 주석처리 하고 싶을경우에는 "컨트롤" + "슬래시" 하면 한번에 주석처리가 가능하다.
        ...
        * 문자열로 취급을 하여 이여 붙이기 (합치기) 결과가 나오게 된다.
        * */
