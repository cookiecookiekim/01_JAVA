...
public class Application01 { // 24-08-27 (화) 6교시 - 비교연산자
    ...
    public static void main(String[] args) {
        ...
        *       연산자 중 참 혹은 거짓을 반환하는 연산자는 조건식이나 조건문의 조건절에 많이 사용된다. (충분한 연습 필요) */
        ...
        System.out.println("num1과 num2가 같은 지 비교 : " + (num1 == num2));
        ...
        /* index. 2. 문자 값 비교 */
        char ch1 = 'a'; // 유니코드 상에서 97
        char ch2 = 'A'; // 유니코드 상에서 65
        // comment. 문자는 내부적으로 숫자로 처리가 되기 때문에 대소비교가 가능하다 !!
        System.out.println("ch1 > ch2 : " + (ch1 > ch2)); // 'a'가 더 크므로 true
