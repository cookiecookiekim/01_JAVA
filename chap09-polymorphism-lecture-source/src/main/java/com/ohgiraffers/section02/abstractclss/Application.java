...
public class Application { // 24-09-12 (목) 1 교시 추상 클래스
...
//        Product product = new Product();
        ...
        /* index. 3. 동적 바인딩을 통해 자료형은 Product지만 SmartPhone 메서드가 호출됨 */

        product.nonStaticMethod();

        // static 메서드는 인스턴스 생성이 불필요
        Product.staticMethod(); // 스태틱 메서드 호출 방법.

        /* comment. 추상클래스 쓰는 이유
        *   추상메서드를 오버라이딩 하는 것에 대해 강제성 부여
        *   따라서 여러 클래스를 그룹화하여 필수 기능을 정의해서 강제성을 부여해
