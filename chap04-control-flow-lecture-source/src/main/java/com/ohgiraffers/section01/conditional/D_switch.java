...
public class D_switch { // 24-09-02 4교시 switch 문

    public void testSwitchStatement() {
        /* title. switch 문 단독 사용에 대한 흐름을 이해할 수 있다. */
        /* comment. [표현식]
        *   switch(비교할 변수) {
        *   case 비교값1 : 비교값1과 일치하는 경우 실행구문; break;
        *   case 비교값2 : 비교값2과 일치하는 경우 실행구문; break;
        *   default : case에 모두 해당하지 않는 경우 실행구문; break;
        *   }*/

        /* comment. 여러개의 비교값 중 일치하는 조건에 해당하는 로직을 실행하는 것은 if-else-if 구문과 유사하다.
        *   하지만 switch문으로 비교가 가능한 값은 정수, 문자, 문자열 형태의 값이다.
        *   실수와 논리는 비교할 수 없다 ← 중요
        *   또한 정확하게 일치하는 경우만 비교할 수 있으며 대소비교를 할 수 없다는 게 차이점이다.
        *   case 절에는 변수를 사용할 수 없다. ← 값민 비교 가능 */

        /* index. 1. 문제
        *   정수 두 개와 연산 기호 문자를 입력 받아, 두 숫자의 연산 결과를 출력해보는 계산기 만들어 보기. */
        ...
        char op = sc.next().charAt(0); // 0 → 0번째 인덱스
        // 입력한 연산기호 문자에 따라서 연산 결과를 다르게 만들어 보기
    ...
    public void testSwitchVendingMachine() { // 24-09-02 4교시 switch 문 break; 활용
        System.out.println("============ HiMedica 음료 자판기 =============");
        ...
        System.out.println("================================================");
        System.out.println("=========== HiMedia 자판기 개선해 보기 ============");
        System.out.println("================================================");
        ...
        System.out.println(orderMenu + " 를 선택하셨습니다. " + price + "원 을 투입해 주세요");
